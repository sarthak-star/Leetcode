...
public:
    ...
    int check_all_records(int cur_ind, int count_a, int count_l, int n,
        ...
        int with_a_next =
            (count_a == 0)
                ? check_all_records(cur_ind + 1, count_a + 1, 0, n, temp)
                : 0;
        int with_l_next =
            (count_l == 2)
                ? 0
                : check_all_records(cur_ind + 1, count_a, count_l + 1, n, temp);
